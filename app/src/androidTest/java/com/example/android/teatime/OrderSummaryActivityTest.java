...
// TODO (1) Add annotation to specify AndroidJUnitRunner class as the default test runner - Done
...
public class OrderSummaryActivityTest {
    ...
    // TODO (2) Add the rule that indicates we want to use Espresso-Intents APIs in functional UI tests - Done
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mActivityRule = new IntentsTestRule<>(OrderSummaryActivity.class);

    // TODO (3) Finish this method which runs before each test and will stub all external - Done
